...
hblNos = ['6079530034012', 'WJ00001373042', '800554161330', '574932590460']
unipass_api(hblNos)



'''
    6079530034012(Princess Switch)                 -   하선장소 반입기간연장 승인
    6079530034012(보라색 키캡)                        -   하선장소 반입기간연장 승인
    WJ00001373042(TESTER68)                        -   하선신고 수리완료
    800554161330(미지아 모니터 LED)                   -   통관목록접수
    
    574932590460(키캡)                              -   미등록
    
    N0000022808543(오링)                            -   반출완료
    574931125614(키보드 거치대)                       -   반출완료
    6079449736486(보라색 키캡)                        -   반출완료
    574932123346(K6)                               -   반출완료
